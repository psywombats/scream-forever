...
enterNVL()
speak('ALISTAIR', "Now do you any of you idiots want a drinky or a snacky?", 'no_highlight')
...
speak('BIANCA', "I am. Just didn’t pack a bottle of water with me.", 'no_anim')
speak('ALISTAIR', "And you, Cynthia?", 'no_highlight')
speak('CYN', "I’ll come in with you, actually. Need the fresh air.")
speak('ALISTAIR', "Understandable. Let’s hop on in, then.", 'no_highlight')
exitNVL()
...
enterNVL()
speak('ALISTAIR', "Oh, and fuelling the car’s on me this time.", 'no_highlight')
choose("No, it’s not.", "No thanks, I will.")
...
choose("It's fine.", "I'm doing okay.")
speak('BIANCA', "We should really go to this chiropractor I know. Her name's Shea Toulouse. She's great.")
speak('LIAM', "Shea Toulouse? I heard my mother say that name once.")
